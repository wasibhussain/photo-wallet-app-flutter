                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        "This is message.. ok is this message, yes this is message. This is message.. ok is this message, yes this is message. yes this is.",
                        style: TextStyle(
                          fontSize: 16,
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                          onPressed: () async {
                            await player.setAsset('assets/birds.mp3');
                            player.play();
